package com.sdkbox.gradle.utils
...
public class Log {
    ...
    def static LEVEL level = LEVEL.VERBOSE

    def static void showSDKBoxLogo() {
        println('')
        println('*****************************************')
        println('SDKBox Gradle Plugin V1.0.0')
        println('*****************************************')
        println('')
    }


    def static void verbose(Object msg) {
    ...
    def static void debug(Object msg) {
    ...
    def static void info(Object msg) {
    ...
    def static void warn(Object msg) {
    ...
    def static void error(Object msg) {
    ...
    def static void logEach(Object... msg) {
        msg.each {
            Object m ->
                try {
                    if (m != null) {
